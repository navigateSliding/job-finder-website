function moreDetails(databaseNumber) {
  ...
  console.log(document.querySelectorAll(".cardFullDetails"));
...
function dynamic_cardGeneration() {
  ...
  for (const incident of data_card) {
    ...
    buttonHTML.setAttribute("onclick", `moreDetails(${count})`);

    console.log(mainDetailsHTML)
    console.log(employerQuestionsHTML)
...
function dynamic_cardDetailsGeneration() {
  ...
  for (const incident of data_cardFullDetails) {
    ...
    incident.keyResponsibilities.map((paragraph) => {
      ...
      responsibilitiesHTML.classList.add("hidden");
    ...
    incident.whatWeOffer.map((paragraph) => {
      ...
      whatweOfferHTML.classList.add("hidden");
    ...
    incident.employerQuestions.map((paragraph) => {
      ...
      employerQuestionsHTML.classList.add("hidden");
